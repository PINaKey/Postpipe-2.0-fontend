...
// ("Plasma"). Zero dependencies: one WebGL
...
export function ShaderBackground({ className }: { className?: string }) {
  ...
  useEffect(() => {
    ...
    // Use ResizeObserver only on the *parent* element, with significant debouncing
    // to avoid firing during smooth CSS transitions (e.g. sidebar expand/collapse)
    ...
    // Observe the canvas parent, not the canvas itself, so flex/grid layout changes
    // that don't change the actual viewport size don't trigger repaints
